...
import numpy as np
import pandas as pd 
import Vecindarios_para_cada_ruta_individual
...
for i in range(len(dir_list)):
    ...
    ruta,positions,distanc,restric,restricc=Vecindarios_para_cada_ruta_individual.VND(data,niter,media,desviacion_estandar,n_iter,tiempos_limites[i])
    ...
    print(i)
path3="C:/Users/johne/OneDrive - Universidad EAFIT/Documentos universidad/2023-1/Heuristica/Trabajo 2/Resultados/mtVRP_JohnEstebanCastro_VecindariosI.xlsx"
